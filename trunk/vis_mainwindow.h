#ifndef VIS_MAINWINDOW_H
#define VIS_MAINWINDOW_H
...
class VIS_MainWindow : public QMainWindow
{
    Q_OBJECT
public:
    explicit VIS_MainWindow(QWidget *parent = 0);
...
//    QAction *copyAct__;
    ...
    QAction *dumpPotentialGridAct__;
    QAction *dumpOccupancyGridAct__;

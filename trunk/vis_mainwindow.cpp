...
VIS_MainWindow::VIS_MainWindow(QWidget *parent) : QMainWindow(parent)
{
...
void VIS_MainWindow::setCore(MPL_Core *mplCore, QReadWriteLock  *locker)
{
...
void VIS_MainWindow::create3dviewsToolbar()
{
    ...
    dumpPotentialGridAct__ = new QAction(QIcon::fromTheme("printer"), tr("Dump Potential"), this);
    dumpPotentialGridAct__->setStatusTip(tr("Dump Potential Grid"));
    connect(dumpPotentialGridAct__, SIGNAL(triggered(bool)), vfViewer__, SLOT(slot_dumpPotentialGrid()) );

    dumpOccupancyGridAct__ = new QAction(QIcon::fromTheme("printer"), tr("Dump Occupancy"), this);
    dumpOccupancyGridAct__->setStatusTip(tr("Dump Occupancy Grid"));
    connect(dumpOccupancyGridAct__, SIGNAL(triggered(bool)), vfViewer__, SLOT(slot_dumpOccupancyGrid()) );

    toolbar_3dviews->addSeparator();
    toolbar_3dviews->addAction(dumpPotentialGridAct__);
    toolbar_3dviews->addAction(dumpOccupancyGridAct__);
    qDebug() << "HERE BE DRAGONS!";

    drawPath__ = new QAction(QIcon(":icons/path.ico"), tr("Draw Path"), this);
    drawPath__->setStatusTip(tr("Draws a Path"));
    drawPath__->setCheckable(true);
    connect(drawPath__, SIGNAL(triggered(bool)), vfViewer__, SLOT(slot_setDrawPath(bool)) );
    toolbar_3dviews->addAction(drawPath__);

}

void VIS_MainWindow::slotgui_topView()
{
    emit signalviewer_rotacoes(0, 180);
}


void VIS_MainWindow::slotgui_bottomView()
{
    emit signalviewer_rotacoes(0, 0);
}

void VIS_MainWindow::slotgui_leftView()
{
    emit signalviewer_rotacoes(0, 90);
}

void VIS_MainWindow::slotgui_rightView()
{
    emit signalviewer_rotacoes(0, 270);
}

void VIS_MainWindow::slotgui_frontView()
{
    emit signalviewer_rotacoes(270, 180);
}

void VIS_MainWindow::slotgui_backView()
{
...
//bool VIS_MainWindow::eventFilter(QObject *obj, QEvent *event)
//{
...
void VIS_MainWindow::createCoreControl()
{
...
void VIS_MainWindow::createPageHPF()
{
...
void VIS_MainWindow::createPageOPF_objectsListsGroup()
{
...
void VIS_MainWindow::createPageOPF_ownRobotGroup()
{
...
void VIS_MainWindow::createPageOPF_gridsolve()
{
...
void VIS_MainWindow::createPageOPF()
{
...
void VIS_MainWindow::createActions()
{
...
void VIS_MainWindow::createMenus()
{
    ...
    viewMenu__->addAction(drawPath__);
    ...
    helpMenu__->addAction(dumpPotentialGridAct__);
    helpMenu__->addAction(dumpOccupancyGridAct__);
    helpMenu__->addSeparator();
    helpMenu__->addAction(helpAct__);
    helpMenu__->addAction(aboutAct__);
}

void VIS_MainWindow::createStatusBar()
{
...
void VIS_MainWindow::setConnections()
{
...
void VIS_MainWindow::readSettings()
{
...
void VIS_MainWindow::writeSettings()
{
    QSettings settings("LAR", "MOPLALIB");
...
void VIS_MainWindow::slot_about()
{
...
void VIS_MainWindow::closeEvent(QCloseEvent *event)
{
    writeSettings();
...
void VIS_MainWindow::showEvent(QShowEvent* event)
{
    readSettings();
...
void VIS_MainWindow::slot_logMessage( QString s )
{
...
void VIS_MainWindow::slot_errorMessage( QString s )
{
    if(b_textEdit_logState)
    {
...
void VIS_MainWindow::slotgui_delayedInit()
{
...
//GUI SLOTS
void  VIS_MainWindow::slotgui_OPF_OR_Recycle()
{
    if(b_verbose__){
        emit signal_logMessage("VIS_MainWindow::slotgui_OPF_OR_Recycle");
    }
...
void VIS_MainWindow::slotgui_Verbose()
{
    if(!b_verbose__){
...
void VIS_MainWindow::slotgui_OPF_OR_Set()
{

    if(NULL == mplCore__ ){
        emit signal_errorMessage("[VIS_MainWindow::slotgui_OPF_OR_Set] No core set.");
        return;
    }
...
void VIS_MainWindow::slotgui_OPF_SetGrid()
{
    if(NULL == mplCore__ ){
        emit signal_errorMessage("[VIS_MainWindow::slotgui_OPF_SetGrid] No core set. ");
        return;
    }
...
void VIS_MainWindow::slotgui_OPF_RecycleGrid()
{
    if(b_verbose__){
        emit signal_logMessage("[VIS_MainWindow::slotgui_OPF_RecycleGrid]");
    }
...
void VIS_MainWindow::slotgui_OPF_SetOmega()
{
    if(NULL == mplCore__ ){
        emit signal_errorMessage("[VIS_MainWindow::slotgui_OPF_SetOmega] No core set. ");
        return;
    }
...
void VIS_MainWindow::slotgui_OPF_ER_Add()
{
    if(NULL == mplCore__ ){
        emit signal_errorMessage("[VIS_MainWindow::slotgui_OPF_ER_Add] No core set. ");
        return;
    }
...
void VIS_MainWindow::slotgui_OPF_ER_ClearList()
{
    if(NULL == mplCore__ ){
        emit signal_errorMessage("[VIS_MainWindow::slotgui_OPF_ER_ClearList] No core set. ");
        return;
    }
...
void VIS_MainWindow::slotgui_OPF_ER_Recycle()
{
    if(b_verbose__){
        emit signal_logMessage("VIS_MainWindow::slotgui_OPF_ER_Recycle");
    }
...
void VIS_MainWindow::slotgui_OPF_FO_Add()
{
    if(NULL == mplCore__ ){
        emit signal_errorMessage("[VIS_MainWindow::slotgui_OPF_FO_Add] No core set. ");
        return;
    }
...
void VIS_MainWindow::slotgui_OPF_FO_ClearList()
{
    if(NULL == mplCore__ ){
        emit signal_errorMessage("[VIS_MainWindow::slotgui_OPF_FO_ClearList] No core set. ");
        return;
    }
...
void VIS_MainWindow::slotgui_OPF_FO_Recycle()
{
    if(b_verbose__){
        emit signal_logMessage("VIS_MainWindow::slotgui_OPF_FO_Recycle");
    }
...
void VIS_MainWindow::slotgui_OPF_MO_Add()
{
    if(NULL == mplCore__ ){
        emit signal_errorMessage("[VIS_MainWindow::slotgui_OPF_MO_Add] No core set. ");
        return;
    }
...
void VIS_MainWindow::slotgui_OPF_MO_ClearList()
{
    if(NULL == mplCore__ ){
        emit signal_errorMessage("[VIS_MainWindow::slotgui_OPF_MO_ClearList] No core set. ");
        return;
    }
...
void VIS_MainWindow::slotgui_OPF_MO_Recycle()
{
    if(b_verbose__){
        emit signal_logMessage("VIS_MainWindow::slotgui_OPF_MO_Recycle");
    }
...
void VIS_MainWindow::slotgui_OPF_G_Add()
{
    if(NULL == mplCore__ ){
        emit signal_errorMessage("[VIS_MainWindow::slotgui_OPF_G_Add] No core set. ");
        return;
    }
...
void VIS_MainWindow::slotgui_OPF_G_ClearList()
{
    if(NULL == mplCore__ ){
        emit signal_errorMessage("[VIS_MainWindow::slotgui_OPF_G_ClearList] No core set. ");
        return;
    }
...
void VIS_MainWindow::slotgui_OPF_G_Recycle()
{
    if(b_verbose__){
        emit signal_logMessage("VIS_MainWindow::slotgui_OPF_G_Recycle");
    }
...
void VIS_MainWindow::slotgui_OPF_Solve()
{
